...
<html lang="ja" xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <?php include( '../webroot/header.html' ) ?>
    <script src="../webroot/formcheck.js"></script>    
  </head>
  <body alink="#FF9900" link="#29338D" text="#1A1A1A">
    <a name="top"></a>
    <table align="center" border="1" cellpadding="2" cellspacing="11" width="99%">
      <tbody id="intro" class="ui-widget-content">
        <tr><td>
        <table border="0" cellpadding="1" width="100%">
        	<tr><td valign="top"><strong>掲示板</strong>
                  <dl><font size="2">
                        <b>スレを立てる前に類似スレが無いか<font color="#ff0000">確認</font>してください．</b>
                  </font></dl>
            </td></tr>
        </table>
        </td></tr>
